...
import { SceneModel } from './scene-v5.model';
import { SceneConfiguration } from '../components/scene-configuration.component';
import { SceneComponentProps } from '../types';
import { DEFAULT_DEVICE_SCREEN_IMAGE_LAPTOP } from '../constants';
...
export const SceneV5: React.FC<SceneComponentProps> = (props) => {
        ...
        {renderEnabled && (
          ...
          >
            ...
            <SceneConfiguration
              ...
              screenImageSrc={
                imageState.imageSrc || DEFAULT_DEVICE_SCREEN_IMAGE_LAPTOP
              }
